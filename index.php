...
<body style="background-color: #00626B;">
    <div class="container">
            ...
            <div class="col-8">
                ...
                <div class="bg-white rounded-3 p-4 px-5 shadow">
                    ...
                    <div class="text-center">
                        <a href="mhs/login-mhs.php" class="btn btn-outline-success btn-success text-white me-2 w-25">Login Mahasiswa</a>
                        <a href="dosen/login-dosen.php" class="btn btn-outline-success btn-success text-white me-2 w-25">Login Dosen</a>
                        <a href="admin/login-admin.php" class="btn btn-outline-success btn-success text-white me-2 w-25">Login Admin</a>
                    </div>
                </div>
